...
| Lantern-loaf | +14 HP | Eat-now-or-one-more-hit. The fight paints **one** selected food (name, +N, count, one Eat). Empty stacks (Pale-cap +0 · 0) stay out of the primary slot. Pale-cap +8 and fogwort +5 are forageable — gathering feeds combat. |
| After a kill | leftover station | Hub keeps You HP, last Acc/they, oil sips, and the selected food so the cockpit does not vanish with the moth. Full Hand advert waits until the next stretch pick. |
